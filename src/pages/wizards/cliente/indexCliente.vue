...
import { getClienteSubStepsConfig } from "@/utils/wizard-imports"
...
// Obtenemos la configuración de sub-pasos para el wizard de cliente
const subStepsConfig = ref(getClienteSubStepsConfig())
