<template>
  ...
  // Observamos cambios en tipoCompaniaSeleccionado para actualizar los sub-pasos si es necesario
  // watch(tipoCompaniaSeleccionado, (newValue) => {
  //   // Aquí puedes implementar la lógica para actualizar los sub-pasos según el tipo de compañía
