...
onMounted(() => {
  ...
  if (salesData) {
    if (salesData.financialInstitution) {
      financialInstitutionValue.value = salesData.financialInstitution;
    }
    if (salesData.paymentAmount !== undefined) {
      amountValue.value = salesData.paymentAmount;
    }
    if (salesData.proofPayment) {
      proofPaymentValue.value = salesData.proofPayment;
    }
    if (salesData.paymentDate) {
      dateValue.value = salesData.paymentDate;
    }
  }
});
