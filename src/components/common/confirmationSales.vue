    ...
    <div v-if="isOpen" class="modal-overlay">
      <ion-card class="modal-container">
        <ion-card-content class="modal-content">
          ...
          <p class="modal-text">¿Has ingresado correctamente toda la información?</p>
          <p class="modal-text">Una vez que continues no podras regresar a estos pasos anteriores</p>
